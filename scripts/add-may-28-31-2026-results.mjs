...
const INPUT = [
  ...
  {
    playedOn: "2026-05-30",
    player1Name: "Benjamin Urrutia",
    player2Name: "José Tomás Donoso",
    outcome: "win",
    winnerIndex: 1,
    score: "6-3; 6-1",
  },
  {
    playedOn: "2026-05-31",
    player1Name: "Jose Luis Halcartegaray",
    player2Name: "Ignacio Streeter",
    outcome: "win",
    winnerIndex: 1,
    score: "9-4",
  },
  {
    playedOn: "2026-05-31",
    player1Name: "Arturo Quiroz",
    player2Name: "Francisco Cuevas",
    outcome: "win",
    winnerIndex: 1,
    score: "6-2; 6-1",
  },
  {
    playedOn: "2026-05-31",
    player1Name: "Vicente Vicuña Loyola",
    player2Name: "Agustin Achondo",
    outcome: "win",
    winnerIndex: 1,
    score: "7-5; 6-3",
  },
    ...
    await sql.query(
      ...
      [
        ...
        JSON.stringify({
          ...
          score: row.score,
          source: "scripts/add-may-28-31-2026-results.mjs",
        }),
      ],
    );
  }
