      ...
      <div className="px-4 py-3 sm:px-6 sm:py-4 lg:px-8">
        <div className="grid grid-cols-1 gap-3 sm:grid-cols-3">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="hidden max-w-xs text-sm leading-relaxed text-white/40 sm:block">
          ...
          {/* Col 3 — Contact */}
          <div>
            <h3 className="mb-2 hidden text-[11px] font-semibold uppercase tracking-widest text-white/30 sm:block">
              Contacto
            </h3>
              ...
              {contactLinks.map(({ icon: Icon, label, href, value }) => (
                <li key={label}>
                  <a
                    ...
                    aria-label={label}
                    className="group flex items-center gap-3 text-sm text-white/55 transition-colors duration-200 hover:text-white sm:items-start"
                  >
                    <Icon className="size-5 shrink-0 text-white/35 transition-colors duration-200 group-hover:text-[#b04d15] sm:mt-0.5 sm:size-4 sm:text-white/25" />
        ...
        {/* Bottom bar */}
        <div className="mt-2 flex flex-col gap-1 border-t border-white/[0.06] pt-2 sm:mt-3 sm:flex-row sm:items-center sm:justify-between sm:pt-3">
